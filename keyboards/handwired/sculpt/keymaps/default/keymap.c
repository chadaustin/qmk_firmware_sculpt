...
*/
  ...
  [1] = LAYOUT( \
    _______, _______, _______, _______, _______, KC_WWW_SEARCH, KC_WWW_REFRESH, _______, _______, KC_MEDIA_PLAY_PAUSE, KC__MUTE, KC__VOLDOWN, KC__VOLUP, _______, _______, _______, \
  ...
  /*
  [1] = LAYOUT( \
    _______, KC_MEDIA_PLAY_PAUSE, KC__MUTE, KC__VOLDOWN, KC__VOLUP, KC_WWW_SEARCH, KC_WWW_REFRESH, f
